...
//import org.apache.flink.training.exercises.hourlytips.{AbstractHourlyTipsTest, TestUtil}
...
//
//class HourlyTipsTest extends TestUtil.AbstractHourlyTipsTest {
//  private val scalaExercise: TaxiRideTestBase.Testable = () => HourlyTipsExercise.main(Array.empty[String])
//
//  @throws[Exception]
//  protected def results(source: TaxiRideTestBase.TestFareSource): util.List[tuple.Tuple3[java.lang.Long, java.lang.Long, java.lang.Float]] = {
